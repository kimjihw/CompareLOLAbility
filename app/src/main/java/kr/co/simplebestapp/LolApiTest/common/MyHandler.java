...
public final class MyHandler extends Handler {
	...
	private final WeakReference<MyHandelerInterface> mActAndFrag;

	public MyHandler(MyHandelerInterface actAndFrag) {
		super(Looper.getMainLooper());
		mActAndFrag = new WeakReference<MyHandelerInterface>(actAndFrag);
	}

	@Override
	public void handleMessage(Message msg) {
		MyHandelerInterface fragment = mActAndFrag.get();
		if (fragment != null) {
